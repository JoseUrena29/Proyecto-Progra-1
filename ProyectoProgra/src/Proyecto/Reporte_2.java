...
public class Reporte_2 {
    ...
    Paragraph titulo;
     public Reporte_2(String nombre, String apellido, String fecha, ArrayList<Datos> productos, String rutaimagen, String pago, String cambio) {
        this.nombre = nombre;
